    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        options: const MapOptions(
          initialCenter: LatLng(51, -0.09), // Check if this needs to be changed
          minZoom: 13,
        ),
        children: [
          TileLayer(
            ...
            left: 0,
            right: 0,
            child: carDetailsCard(car: Car(model: 'Model S', distance: 120, fuelCapacity: 75, pricePerHour: 100))
          )
